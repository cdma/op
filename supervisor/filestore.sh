...
export HOME=/home/op
export LOGDIR=$HOME/logs/babel/filestore/gc
# export LOGDIR
...
JAVA_OPT="${JAVA_OPT} -verbose:gc -Xloggc:${LOGDIR}/filestore_gc_%p_%t.log -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+PrintGCApplicationStoppedTime -XX:+PrintAdaptiveSizePolicy -XX:+ExplicitGCInvokesConcurrentAndUnloadsClasses"
...
$JAVA -jar babelfile-1.0.jar  ${JAVA_OPT} $@
